...
export const SUITES = {
  app: [
    ...
    "src/components/flow/flow-canvas.test.ts",
    "src/components/flow/flow-executions.test.ts",
    "src/components/flow/flow-toolbar.test.ts",
    "src/components/flow/node-detail-view.test.ts",
    "src/components/flow/flow-library.test.ts",
    ...
    "src/lib/familiar-library-workspaces.test.ts",
    "src/lib/github-repo.test.ts",
    "src/lib/article-extract.test.ts",
    "src/lib/research-run.test.ts",
