...
assert.match(source, /isAllowedRequestSource\(req\.headers\.get\("origin"\), expectedOrigin, mobileAccessAuthenticated\)/, "valid mobile access should satisfy the API origin gate");
assert.match(source, /isAllowedRequestSource\(req\.headers\.get\("referer"\), expectedOrigin, mobileAccessAuthenticated\)/, "valid mobile access should satisfy the API referer gate");
